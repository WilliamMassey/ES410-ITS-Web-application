...
# Aspects of the project not covered in the are:
* URL files
* settings file
* admin files

# The reason these aspects of the project are omitted from the portfolio is that although they essential parts of the project, there are no design choices but complete fudamental but mundate tasks. 
