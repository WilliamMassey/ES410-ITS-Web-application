...
TEMPLATES = [
    {
        ...
        'DIRS': [ BASE_DIR/'reactapp/build'], # This give access to django HTML templates created by react when created
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'# giving django access to the static files (CSS, JavaScript, Images) from the react app
